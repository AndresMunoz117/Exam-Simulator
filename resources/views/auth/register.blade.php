...
rounded-lg shadow-lg">
  ...
  <form class="mt-4" method="POST" action="">
    ...
    <input type="tex" class="border border-gray-200 rounded-md bg-gray-200 w-full
    ...
    <input type="tex" class="border border-gray-200 rounded-md bg-gray-200 w-full
    text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Tipo usuario Docente/Alumno"
